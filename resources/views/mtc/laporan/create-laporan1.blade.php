...
@endsection
@section('main')
<x-bladewind.card class="display">
                ...
                <div class="sm:col-span-2">
                    <div class="columns-3">
                        <div class="w-full">
                            ...
                            <input type="text" name="nolk" id="nolk" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="No-LK" readonly>
                        </div>
                        <div class="w-full">
