...
<section class="bg-white dark:bg-gray-800">
    ...
    <div class="py-8 px-4 mx-auto lg:py-16">
        ...
        <br>
        <form action="{{ route('complete.update', $data->id) }}" method="post" >
            @method('PATCH')
            @csrf
            <div class="grid gap-2 sm:grid-cols-2 sm:gap-6">
                ...
                <br>
                <div class="columns-3 grid grid-flow-col justify-normal">
                    <x-bladewind.card>
                        <div class="w-full">
                ...
                <div class="m:col-span-3">    
                    <h6 class="text-lg font-extrabold dark:text-white">Waktu <small class="ml-2 font-semibold text-gray-500 dark:text-gray-400">Penyelesaian Pekerjaan</small></h6>
                        ...
                        <div class="columns-4">
                            <div class="w-full">
                                ...
                                <input type="text" name="eksekusiday" id="eksekusiday" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value="{{$data->eksekusiday}}" readonly>
                            </div>
                            <div class="w-full">
                                <label for="mulai-kerja" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jam Awal</label>
                                <input type="text" name="starkerja" id="starkerja" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value="{{$data->starkerja}}" readonly>
                            </div>
                            <div class="w-full">
                                <label for="selesai-kerja" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jam Akhir</label>
                                <input type="text" name="endkerja" id="endkerja" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value="{{$data->endkerja}}" readonly>
                            </div>
                            <div class="w-full">
                                <label for="manhour" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jumlah (Man Hour)</label>
                                <input type="text" name="manhour" id="manhour" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value="{{$data->manhour}} H" readonly>
                            </div>
                        </div>
                    </div>
                    <br>
                    <div class="columns-3">
                        <div class="w-full">
                            ...
                            <input type="text" name="hasil" id="hasil" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value="{{$data->hasil}}" readonly>
                        </div>
                        <div class="w-full">
                            <label for="cegah" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Cara Pencegahan Masalah</label>
                            <input type="text" name="cegah" id="cegah" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value="{{$data->cegah}}" readonly>
                        </div>
                        <div class="sm:col-span-3">
                            <label for="material" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Material Yang Dibutuhkan</label>
                            <input type="text" name="material" id="material" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value="{{$data->material}}" readonly>
                        </div>
                    </div>
                 <br>
            </div>
            <div class="w-full">
                <label for="spvmtc" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">TTD SPV Produksi</label>
                <div id="sigspvmtc" ></div>
                    <br/>
                    <button id="clearspvmtc" class="bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded items-center">Clear Signature</button>
                    <textarea id="signature64_spvmtc" name="signedspvmtc" style="display: none"></textarea>
                </div>
            </div>
            <br>
            <br>
...
<script type="text/javascript">
    var sigspvmtc = $('#sigspvmtc').signature({syncField: '#signature64_spvmtc', syncFormat: 'PNG'});
    $('#clearspvmtc').click(function(e) {
        e.preventDefault();
        sigspvmtc.signature('clear');
        $("#spvmtc").val('');
    });
</script>
@endsection
