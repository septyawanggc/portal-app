...
<section class="bg-white dark:bg-gray-800">
    ...
    <div class="py-8 px-4 mx-auto lg:py-16">
        ...
        <form action="{{ route('complete.update', $data->id) }}" method="post" >
            ...
            <div class="w-full">
                <label for="operator" class=" mb-2 text-sm font-medium text-gray-900 dark:text-white">TTD SPV Maintenance</label>
                    <img class="h-auto max-w-lg rounded-lg" src="{{ asset($data->spvmtc) }}" alt="ttd operator" style="width: auto; height: 150px;">
            </div>
            <br>
        </form>
        <a href="/laporan"><button class="px-6 top-10 py-2.5 text-sm font-medium text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 items-center">
            Kembali
        </button></a>
    </div>
    </x-bladewind.card>
