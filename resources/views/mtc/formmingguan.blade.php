...
<section>
     <aside id="default-sidebar" class="fixed top-50 left-0 z-40 w-64 h-screen transition-transform -translate-x-full bg-[#3b82f6] dark:bg-gray-800 sm:translate-x-0" aria-label="Sidebar">
        <div class="h-full px-3 py-4 overflow-y-auto bg-[#3b82f6] dark:bg-gray-800">
